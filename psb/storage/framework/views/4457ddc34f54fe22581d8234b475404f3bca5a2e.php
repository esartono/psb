				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-head">
							...
							<div class="country">Dokumen</div>
							<div class="visit">File</div>
						</div>
						<div class="table-row">
						...
						<!-- <div class="table-row">
							...
							<div class="country">Tata Tertib Siswa Nurul Fikri</div>
...
<?php echo $__env->make('front.template1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tik/psb/resources/views/front/download.blade.php ENDPATH**/ ?>