...
<br>
<br>
    <center><h2><b>TATA CARA PEMBAYARAN BIAYA PENDAFTARAN<br>PENERIMAAN SISWA BARU SIT NURUL FIKRI</b></h2></center>
        <br>
        ...
        <ol>
            <li>
                ...
                <p>Melakukan Pembayaran jenis Edupay dengan Nama Lembaga Yayasan Pendidikan dan Pemberdayaan Umat Nurul Fikri dengan nomor pembayaran menggunakan nomor pendaftaran <b><?php echo e($calonsnya->uruts); ?></b> (Sesuai nomor pendaftaran)</p>
            </li>
            <li>
                ...
                <ol>
                    ...
                    <li>Masukkan kode institusi, YPPU Nurul Fikri - <b>3292</b> dan nomor pendaftar <b><?php echo e($calonsnya->uruts); ?></b> (sesuai nomor pendaftaran).</li>
            ...
            <li>
                ...
                <ol>
                    ...
                    <li>Masukkan nomor pendaftar <b><?php echo e($calonsnya->uruts); ?></b> (sesuai nomor pendaftaran).</li>
                    <li>Masukan PIN</li>
            ...
            <li>
                ...
                <ol>
                    ...
                    <li>Pilih Nama Lembaga Edupay - Yayasan Pendidikan dan Pemberdayaan Umat Nurul Fikri</li>
                    <li>Masukkan nomor pendaftar sebagai kode pembayaran <b><?php echo e($calonsnya->uruts); ?></b> (sesuai nomor pendaftaran).</li>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>Kode Pendaftaran : <b><?php echo e($calonsnya->uruts); ?> (sesuai nomor pendaftaran).</b></li>
                            contoh : <b>451 900 3292 <?php echo e($calonsnya->uruts); ?></b>
                        </ul>
                    </li>
            ...
            <li>
                <b>Melalui Mobile Banking atau Net Banking Bank Lain</b>
                <ol>
                    <li>Pilih Menu Transfer ke Bank Lain</li>
                    <li>
                        Masukan Nomor Rekening Tujuan
                        <ul>
                            ...
                            <li>Kode YPPU Nurul Fikri : <b>3292</b></li>
                            <li>Kode Pendaftaran : <b><?php echo e($calonsnya->uruts); ?> (sesuai nomor pendaftaran).</b></li>
                            contoh : <b>900 3292 <?php echo e($calonsnya->uruts); ?></b>
                        </ul>
                    </li>
                    <li>Masukan nominal pembayaran, <b>harus sesuai dengan jumlah tagihan</b></li>
                    <li>Pilih jenis Rekening Tujuan - <b>GIRO</b></li>
...
<?php /**PATH /home/tik/psb/resources/views/pdf/tatacara.blade.php ENDPATH**/ ?>