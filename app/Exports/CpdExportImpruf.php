...
class CpdExportImpruf implements FromView
{
    public function view(): view
    {
        ...
        $getCalon = Calon::whereIn('gel_id', [16, 17])->get()->pluck('id');
        ...
        $calons = DB::table('calons')
            ->select(
                ...
                'calon_tagihan_p_s_b_s.daul as daul',
                'calon_tagihan_p_s_b_s.lain as lain'
            )
            ...
            ->orderBy('calon_tagihan_p_s_b_s.updated_at', 'asc')
            ->get();
        // }

        return view('exports.impruf', [
            'calons' => $calons,
            'no' => 1,
        ]);
    }
