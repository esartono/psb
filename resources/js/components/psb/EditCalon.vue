        ...
        mounted() {
            axios
                ...
                .then(( data ) => {
                    ...
                    axios
                        .get("../api/kecamatan/" + data.data.kota)
                        .then(( camat ) => {(this.camats = camat.data)
                    })
                    axios
                        .get("../api/kelurahan/" + data.data.kecamatan)
                    ...
                    axios
                        .get("../api/kecamatan/" + data.data.asal_kota_sekolah)
                        .then(( camat ) => {(this.camatsekolah = camat.data)
                    })
                    axios
                        .get("../api/kelurahan/" + data.data.asal_kecamatan_sekolah)
                        .then(( lurah ) => {(this.lurahsekolah = lurah.data)
                    })
                    axios
