            ...
            <div class="col-md-12">
                <div class="card border-info">
                    ...
                    <div class="card-body p-0">
                        <v-table :data="beritas" :filters="filters" :currentPage.sync="currentPage" :pageSize="7"
                            @totalPagesChanged="totalPages = $event"
                            class="table table-bordered table-hover table-head-fixed">
                            <thead slot="head">
                                <th>No.</th>
                                <v-th sortKey="judul">Judul</v-th>
                                <v-th sortKey="berita">Berita</v-th>
                                <th>Aksi</th>
                            </thead>
                    ...
                    <div class="modal-content">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            <div class="modal-header">
                                <h5 class="modal-title" v-show="!editmode" id="addModalLabel">Form Tambah Berita</h5>
                                <h5 class="modal-title" v-show="editmode" id="addModalLabel">Form Edit Berita</h5>
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        this.form
                            ...
                            .then(() => {
                                Swal.fire("Berhasil!", "Berita telah di hapus.", "success");
                                Fire.$emit("listData");
                            })
                            .catch(() => {
                                Swal.fire(
