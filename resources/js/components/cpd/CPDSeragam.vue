            ...
            <div class="col-md-12">
                <div class="card border-info">
                    <div class="card-header bg-info">
                        <h3 class="card-title">Daftar Seragam Peserta PPDB Online - SIT Nurul Fikri</h3>
                        <div class="card-tools">
                            <a href="/EksportSeragam" class="btn btn-sm btn-warning mr-2 ml-2">
                                <b><i class="fas fa-file-excel"></i>
                                Eksport Data Seragam</b>
                            </a>
                        ...
                        <v-table :data="calons" :filters="filters" :currentPage.sync="currentPage" :pageSize="7"
                            ...
                            <thead slot="head">
                                <tr>
                                    ...
                                    <v-th sortKey="atas">Baju/Blouse</v-th>
                                    <v-th sortKey="bawah">Celana/Rok</v-th>
                                </tr>
                            </thead>
                            <tbody slot="body" slot-scope="{displayData}">
                                <tr v-for="(row, index) in displayData" :key="row.id">
                                    ...
                                    <td class="text-center">{{ row.atas }}</td>
                                    <td class="text-center">{{ row.bawah }}</td>
                                </tr>
                            </tbody>
                        </v-table>
        ...
        data() {
            return {
                ...
                filters: {
                    name: {
                        value: "",
                        keys: ["unit", "uruts", "name", "atas", "bawah"]
                    }
                },
                currentPage: 1,
                totalPages: 0,
