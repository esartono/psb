                        ...
                        <div class="clearfix">
                            ...
                            <table width="100%" class="table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ calon.hasil.tagihan.pengembangan | toCurrency }}</td>
                                </tr>
                                <tr>
                                    <td>Dana Pendidikan</td>
                                    <td class="text-right">{{ calon.hasil.tagihan.pendidikan | toCurrency }}</td>
                                </tr>
                                <tr>
                                    <td>Iuran SPP bulan Juli</td>
                                    <td class="text-right">{{ calon.hasil.tagihan.spp | toCurrency }}</td>
                                </tr>
                                <tr>
                                    <td>Iuran Komite Sekolah / tahun</td>
                                    <td class="text-right">{{ calon.hasil.tagihan.komite | toCurrency }}</td>
                                </tr>
                                <tr>
                                    <td>Dana Seragam</td>
                                    <td class="text-right">{{ calon.hasil.tagihan.seragam | toCurrency }}</td>
                                </tr>
                                <tr>
                                    <td>Potongan</td>
                                    <td class="text-right">({{ calon.hasil.tagihan.diskon | toCurrency }})</td>
                                </tr>
                                <tr>
                                    <td>Infaq</td>
                                    <td class="text-right">{{ calon.hasil.tagihan.infaq | toCurrency }}</td>
                                </tr>
                                <tr>
                                    <th>TOTAL TAGIHAN</th>
                                    <td class="text-right">{{
