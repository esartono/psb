        ...
        <div class="card border-info">
          <div class="card-header bg-info">
            ...
            <div class="card-tools">
              ...
              <a href="/EksportBayar" class="btn btn-sm btn-success">
            ...
            >
              ...
              <tbody slot="body" slot-scope="{displayData}">
                <tr v-for="(row, index) in displayData" :key="row.id">
                  ...
                  <td width="150px">{{ row.pendaftaran }}</td>
          ...
          <div class="modal-content">
            <form @submit.prevent="editmode ? updateData() : createData()">
              <div class="modal-header">
                <h5 class="modal-title" v-show="!editmode" id="addModalLabel">Form Transaksi Pembayaran Biaya PPDB</h5>
                <h5 class="modal-title" v-show="editmode" id="addModalLabel">Form Edit Transaksi Pembayaran Biaya PPDB</h5>
