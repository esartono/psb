    ...
    <div class="row">
        <div class="col-md-8">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="4" class="text-center">Sekolah Menengah Atas</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr bgcolor="#01DFD7">
                        ...
                        <td class="currency"><b>Rp. 42.950.000,-</b></td>
                    </tr>
                    <tr bgcolor="#f1948a">
                        <td><b>Total Biaya PUTRI</b></td>
                        <td class="currency"><b>Rp. 37.550.000,-</b></td>
                        <td class="currency"><b>Rp. 43.650.000,-</b></td>
                    </tr>
                    <tr>
                        <th colspan="4">
                            <ul>
                                <li>
                                    ...
                                    <ol>
                                        <li><b>Tahun ke 2</b> : Rp. 4.500.000</li>
                                        <li><b>Tahun ke 3</b> : Rp. 5.000.000</li>
                                    </ol>
                                </li>
