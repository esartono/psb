<!-- unit tk -->
    ...
    <h3>CCEC Nurul Fikri</h3>
    <div class="row">
        <div class="col-md-8">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="3" class="text-center">Play Group</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <th colspan="4">
                            <ul>
                                <li>Dana Daftar Ulang Tahunan (Dana kegiatan) mulai tahun kedua sebesar Rp. 2.000.000 / tahun</li>
