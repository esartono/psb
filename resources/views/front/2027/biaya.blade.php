                ...
                <div class="progress-table" style="padding: 25px">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>1.</td>
                                <td>Asal Non Nurul Fikri Islamic School</td>
                                <td>Rp. 200,000</td>
                                <td>Rp. 500,000</td>
                                <td>Rp. 650,000</td>
                                <td>Rp. 850,000</td>
                            ...
                            <tr>
                                <td>2.</td>
                                <td>Asal Nurul Fikri Islamic School</td>
                                <td>Rp. 200,000</td>
                                <td>Rp. 400,000</td>
                                <td>Rp. 500,000</td>
                                <td>Rp. 550,000</td>
                            ...
                            <tr>
                                <td>3.</td>
                                <td>Anak Pegawai Nurul Fikri Islamic School</td>
                                <td>Rp. 200,000</td>
                                <td>Rp. 250,000</td>
                                <td>Rp. 325,000</td>
                                <td>Rp. 425,000</td>
                    ...
                    <p class="mt-40">C. Tambahan Biaya Untuk Murid dengan Penanganan Lanjutan</p>
                    ...
                    <p></p>
                    <p class="mt-40">D. Biaya Todler dan Afterschool Program CCEC</p>
                    <table class="table table-bordered table-striped khusus">
                        <thead>
                            <tr>
                                <th>Komponen Biaya</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Overtime/jam</td>
                                <td style="text-align: right;">Rp. 35,000</td>
                                <td style="text-align: right;">Rp. 35,000</td>
                            </tr>
                        </tbody>
                    </table>
