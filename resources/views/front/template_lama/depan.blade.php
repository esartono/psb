...
@extends('front.template_lama.template1')
						...
						@if (Route::has('login'))
							<div class="top-right links">
								@auth
									...
									@endif
								@else
									<a href="{{ route('login') }}" data-wow-duration="1s" data-wow-delay=".3s" class="genric-btn col-md-5 danger circle mr-10 mb-10 wow fadeInDown">DAFTAR/LOGIN</a>
									<br>
