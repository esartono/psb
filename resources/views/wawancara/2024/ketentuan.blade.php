<ol class="roman">
    <li>Ketentuan Umum
        <ol class="biasa">
            ...
            <li>Biaya Komite Sekolah untuk tahun pertama, dibayarkan bersamaan dengan SPP bulan Juli</li>
            ...
            <li>
                ...
                <table class="table table-bordered table-striped" style="width: 76%">
                    <tr>
                        ...
                        <th style="width: 20%">31 Oktober 2023</th>
                        <th style="width: 20%">30 November 2023</th>
                        <th style="width: 20%">31 Desember 2023</th>
                    </tr>
                    <tr>
            ...
            <li>Untuk pendaftar yang melakukan pelunasan biaya daftar ulang setelah tanggal 31 Desember 2023, tidak mendapatkan tambahan potongan.</li>
        </ol>
    </li>
        ...
        <ol class="biasa">
            ...
            <li>Jenis Potongan Khusus sebagai berikut:
                <ol class="step1">
                    ...
                    <li>
                        <div class="jarak"></div>
                        c. Potongan Prestasi<ol class="step2">
                ...
                <table class="table table-bordered table-striped spp">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">Rp. 1,350,000</td>
                            <td style="text-align: right">Rp. 1,550,000</td>
                            <td style="text-align: right">Rp. 1,550,000</td>
                            <td style="background-color: grey">-</td>
                            <td style="background-color: grey">-</td>
                            <td style="background-color: grey">-</td>
