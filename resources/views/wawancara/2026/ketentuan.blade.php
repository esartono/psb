<ol class="roman">
    <li>Ketentuan Umum
        <ol class="biasa">
            <li>Komponen Dana Pengembangan, dan Dana Pendidikan (termasuk sarana dan bahan ajar untuk tahun pertama) dibayarkan satu kali selama menempuh pendidikan di unit terkait</li>
            <li>Sumbangan Pokok Pendidikan (SPP) dibayarkan mulai bulan Juli pada tahun ajaran berjalan</li>
            <li>SPP yang dibayarkan tidak termasuk biaya catering</li>
            <li>SPP SD, SMP dan SMA dibayarkan sudah termasuk program UKS</li>
            <li>Biaya Komite Sekolah untuk tahun pertama, dibayarkan pada bulan Juli</li>
            ...
            @isset($ctg)
            {{-- <li>Bersedia mengikuti kegiatan Umrah Plus QCC di kelas IX / Program Impruf di kelas XI dengan pembiayaan sendiri sesuai ketentuan SIT Nurul Fikri.</li> --}}
            <br>
            @endisset
            ...
            <li>
                ...
                <table class="table table-bordered table-striped" style="width: 76%">
                    <tr>
                        ...
                        <th style="width: 20%">31 Oktober 2025</th>
                        <th style="width: 20%">30 November 2025</th>
                        <th style="width: 20%">31 Desember 2025</th>
                    </tr>
                    <tr>
            ...
            <li>Untuk pendaftar yang melakukan pelunasan biaya daftar ulang setelah tanggal 31 Desember 2025, tidak mendapatkan tambahan potongan.</li>
            <li>Siswa mendapatkan perangkat pembelajaran sesuai dengan ketentuan di SIT Nurul Fikri.</li>
        </ol>
    </li>
    <li>Ketentuan Khusus Potongan Biaya PPDB
        <ol class="biasa">
            ...
            <li><b>Dana Pengembangan</b> yang digunakan untuk <b>perhitungan diskon khusus adalah setelah dikurangi potongan umum pada ketentuan umum.</b></li>
            ...
            <li>Jenis Potongan Khusus sebagai berikut:
                <ol class="step1">
                    <li>
                        ...
                        <ol class="step2">
                            <li>Potongan Dana Pengembangan bagi calon siswa yang memiliki saudara kandung yang sedang bersekolah di SIT Nurul Fikri, sebagai berikut:
                                <ol class="step3">
                            ...
                            <li>Potongan Dana Pengembangan bagi orangtua calon siswa yang mendaftarkan (sampai dengan daftar ulang lunas) lebih dari 1 calon siswa pada tahun pelajaran yang sama di SIT Nurul Fikri, masing-masing calon siswa mendapatkan potongan sebesar 10% dari Dana Pengembangan.</li>
                        </ol>
                    </li>
                    <li><div class="jarak"></div>b. Potongan Internal
                        <ol class="step2">
                    ...
                    <li><div class="jarak"></div>c. Potongan Prestasi
                        <ol class="step2">
                            <li>Potongan biaya 25% dari Dana Pengembangan dan bebas biaya pendaftaran bagi calon siswa yang berasal dari SIT Nurul Fikri dan NFBS Bogor yang mendapatkan undangan khusus dari Direktorat Pendidikan SIT Nurul Fikri.</li>
                            <li>Potongan biaya 50% dari Dana Pengembangan bagi calon siswa Pemenang Lomba <br>Tingkat Nasional (Berjenjang) Juara 1 dan 2, yang dibuktikan dengan sertifikat dan diverifikasi oleh panitia.</li>
                            <div class="page-break"></div>
                    ...
                    <li><div class="jarak"></div>d. <b>Ketentuan khusus potongan biaya penerimaan siswa baru tidak bersifat akumulatif</b></li>
                    <li><div class="jarak"></div>e. <b>Hasil keputusan panitia PPDB tidak dapat diganggu gugat</b></li>
                </ol>
            </li>
        </ol>
    </li>
    ...
    <div class="jarak1"></div>
    <li>
        Ketentuan SPP dan Daftar Ulang Tahunan
        <ol class="biasa">
            <li>
                ...
                <table class="table table-bordered table-striped spp">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2" style="text-align: center; vertical-align: middle;">Play Group</td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">Rp. 1,750,000</td>
                            <td style="text-align: right">Rp. 1,850,000</td>
                            <td style="background-color: grey; text-align: center">-</td>
                            <td style="background-color: grey; text-align: center">-</td>
                            <td style="background-color: grey; text-align: center">-</td>
                        </tr>
                        <tr>
                            ...
                            <td rowspan="2" style="text-align: center; vertical-align: middle;">TK A</td>
                            <td style="text-align: center">Dana Tahunan</td>
                            <td style="background-color: grey; text-align: center">-</td>
                            <td style="text-align: right">Rp. 2,000,000</td>
                            <td style="background-color: grey; text-align: center">-</td>
                        ...
                        <tr>
                            ...
                            <td rowspan="2" style="text-align: center; vertical-align: middle;">TK B</td>
                            <td style="text-align: center">Dana Tahunan</td>
                            <td style="background-color: grey; text-align: center">-</td>
                            <td style="background-color: grey; text-align: center">-</td>
                            <td style="background-color: grey; text-align: center">-</td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">Rp. 2,600,000</td>
                            <td style="text-align: right">Rp. 2,700,000</td>
                            <td style="text-align: right">Rp. 2,800,000</td>
                        </tr>
                        <tr>
                            <td rowspan="2" style="text-align: center; vertical-align: middle;">5</td>
                            <td rowspan="2" style="text-align: center; vertical-align: middle;">SMP</td>
                            <td style="text-align: center">Dana Tahunan</td>
                            <td style="background-color: grey; text-align: center">-</td>
                        ...
                        <tr>
                            ...
                            <td rowspan="2" style="text-align: center; vertical-align: middle;">SMA</td>
                            <td style="text-align: center">Dana Tahunan</td>
                            <td style="background-color: grey; text-align: center">-</td>
                            <td style="text-align: right">Rp. 5,000,000</td>
            ...
            <li>Dana daftar ulang tahunan meliputi dana kegiatan serta sarana belajar dan perangkat pembelajaran</li>
            <li>Kenaikan SPP diberlakukan saat awal tahun ajaran sesuai dengan ketentuan yang berlaku</li>
        </ol>
    </li>
</ol>
