...
<br>
    ...
    <ol>
        <li>Digabungkan dengan pembayaran SPP (SPP + Tabungan {{ $ketProgramNF }}).</li>
        <li>Tabel pembiayaan {{ $ketProgramNF }}
            <table class="rincian">
                <tr>
                    ...
                    @endphp
                    <th colspan="{{ $kolom }}">Teknis Tabungan</th>
                </tr>
                <tr>
                    @for ($i = 1; $i <= $kolom; $i++)
                ...
                @for ($i = 1; $i <= $kolom; $i++)
                    <td style="text-align: center">
                        ...
                        atau <br>
                        {{ number_format($programNF['bulanan'][$i]) }} / bulan <br>
                ...
                <tr>
                    ...
                    <td>
                        <ol>
                            ...
                            @endphp
                            @for ($i = 1; $i <= $kolom; $i++)
                                <li style="margin-bottom: 8px">Term. {{ $i }} : Rp. {{ number_format($programNF['tahunan'][$i]) }} ( tgl .......................... maksimal tanggal 10 Juli {{ $ta + $i - 1 }})</li>
                            @endfor
                        </ol>
