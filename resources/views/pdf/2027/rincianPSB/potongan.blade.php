          ...
          <tr>
            ...
            @php
              if($b == 'Dana Pengembangan') {
                ...
                if($calon->gel_id == 21 && $calon->asal_nf == 1) {
                  $d1 = 5000000;
                  $d2 = 5000000;
                  $d3 = 5000000;
                }
          ...
          <table class="rincian">
            ...
            @if($ctg->keterangan === 'Diskon anak PEGAWAI TETAP')
              ...
              @isset($diskon[2])
                <tr>
                  <td>2</td>
                  <td>Diskon Pelunasan untuk pembayaran maksimal tanggal : <b>{{ $pengumuman }}</b><br>*<i style="font-size: 75%">Diskon khusus : {{ $ctg->keterangan }}</i></td>
