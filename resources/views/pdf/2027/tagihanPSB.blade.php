...
<style type="text/css">
    ...
    table.spp tr td {font-size: 11px; padding: 10px 5px;}
    table.spp tr th { font-size: 11.5px; padding: 10px 5px;}
</style>
    <div class="main">
        <br>
        <table style="width: 100%; margin: 6mm 0 2mm 0;">
            <tr>
                <td style="text-align: center; font-size: 7mm; font-weight: bold"><br>SURAT PERNYATAAN</td>
            </tr>
        </table>
        <br>
        <table align="center" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    Kecamatan {{ Str::title(App\Kecamatan::nama($calon->kecamatan)) }},
        ...
        <table style="width: 100%; margin-top: 2mm">
            ...
            <tr>
                <td width="7mm"></td>
                <td width="48mm"> Nama Calon Peserta Didik</td>
                <td width="1mm"> : </td>
            ...
            <tr>
                <td width="7mm"></td>
                <td valign="top" align="left">Saudara Kandung di NFIS </td>
        ...
        <table style="width: 100%">
            <tr>
                <td>
                    Dengan ini menyatakan dengan sebenarnya <strong>memahami dan menyetujui</strong> ketentuan administrasi Nurul Fikri Islamic School sebagai berikut:
                </td>
            </tr>
        </table>
        <br>
        ...
        <table align="center" width="100%" style="font-size: 15px;">
            <tr>
                <td colspan="2" align="center"><u> Depok, {{ formatIndo($ctg->created_at->format('Y-m-d')) }} </u><br><br></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
