...
<style type="text/css">
    ...
    .keterangan {text-decoration: none; color: black} 
    .keterangan:link {text-decoration: none; color: black} 
    .keterangan:visited {text-decoration: none; color: black}
    .keterangan:hover {text-decoration: none; color: black}
    .keterangan:active {text-decoration: none; color: black}
</style>
                ...
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-2">
                        <li class="list-group-item">
                            <b>Tempat, Tanggal lahir</b> <a class="float-right keterangan">{{ $calon->tempat_lahir }}, {{ $calon->tgl_lahir->isoFormat('D MMMM Y') }}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Jenis Kelamin</b> <a class="float-right keterangan">{{ $calon->kelamin }}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Kelas Tujuan</b> <a class="float-right keterangan">Kelas {{ $calon->kelasnya->name }}
                        ...
                        <li class="list-group-item">
                            <b>Tanggal Daftar</b> <a class="float-right keterangan">{{ $calon->tgl_daftar->isoFormat('D MMMM Y') }}</a>
                        </li>
                        <li class="list-group-item">
                            <b>Email Pendaftar</b> <a class="float-right keterangan">{{ Auth()->user()->email }}</a>
                        </li>
                        @if($calon->inggris <> 'Kosong')
                            <li class="list-group-item">
                                <b>English Placement Test</b> <a class="keterangan">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-tabs h-100" aria-orientation="vertical">
                                ...
                                <p class="nav-link status {{ $calon->tahap >= 7 ? 'active' : '' }}">8. Pengambilan Seragam @if($calon->tahap >= 7) <i class="fas fa-check-circle float-right"></i>@endif</p>
                                <p class="nav-link status {{ $calon->tahap >= 9 ? 'active' : '' }}">9. Pengambilan Media Pembelajaran @if($calon->tahap >= 9) <i class="fas fa-check-circle float-right"></i>@endif</p>
                                <p class="nav-link status {{ $calon->tahap >= 9 ? 'active' : '' }}">10. Masa Orientasi Siswa @if($calon->tahap >= 9) <i class="fas fa-check-circle float-right"></i>@endif</p>
                            </div>
                        </div>
                        <div class="col-9">
