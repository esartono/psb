  ...
  <div class="container">
      <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="logo-area">
                  <a href="/home"><img style="max-width: 50px" src="/img/logo.png" alt="" /> PPDB SIT Nurul Fikri - Depok</a>
              </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="logo-area mt-1 text-end">
                  <a href="/home" class="btn btn-outline-light">HOME</a>
                  <a href="/list_praWawancara" class="btn btn-outline-light mx-3">Kelengkapan Seleksi</a>
