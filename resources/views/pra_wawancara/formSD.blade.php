                    ...
                    <div class="alert">
                        ...
                        <div class="mb-4">
                            <label class="form-label">
                                <table><tr>
                                    <td>5. </td>
                                    <td>Bagaimana peran Bapak/Ibu dalam membangun kebiasaan beribadah ananda sehari-hari?</td>
                                </tr></table>
                            </label>
                            ...
                            <div class="mx-4">
                                <div class="mb-4">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>2. </td>
                                            <td>Penggunaan Google Classroom untuk mendukung pelaksanaan flipped classroom yang  memfasilitasi siswa mempelajari materi sebelum pembelajaran tatap muka dilaksanakan</td>
                                            <td>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="pertanyaan[20]" value="Berkaitan dengan relasi orangtua dan anak, ceritakan aktivitas rutin dan komunikasi yang dilakukan Bapak/Ibu bersama Ananda!">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="pertanyaan[21]" value="Apa tantangan yang Bapak/Ibu hadapi dalam proses perkembangan anak dan bagaimana bapak dan ibu mengatasi tantangan tersebut?">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="pertanyaan[22]" value="Guru dan pihak sekolah berperan laksana orangtua kedua di sekolah dalam mendidik ananda. Bagaimana bentuk dukungan yang dapat Bapak/Ibu lakukan agar terjalinnya kerjasama yang positif antara orangtua dan pihak sekolah?">
